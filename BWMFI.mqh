...
/**
 * @file
 * Implementation of BWMFI Strategy based on the Market Facilitation Index indicator.
 *
 * @docs
...
// User inputs.
#ifdef __input__ input #endif string __BWMFI_Parameters__ = "-- Settings for the Market Facilitation Index indicator --"; // >>> BWMFI <<<
#ifdef __input__ input #endif double BWMFI_SignalLevel = 0.00000000; // Signal level
#ifdef __input__ input #endif int BWMFI_SignalMethod = 0; // Signal method for M1 (0-

class BWMFI: public Strategy {
protected:
  ...
  bool Update(int tf = EMPTY) {
    // Calculates the Market Facilitation Index indicator.
